function data = get_e1_from_csv(filepath)
    ...
    data_temp = data(:,1:firstcol-1);
    
    vars = data_temp.Properties.VariableNames;
    vars = string(vars);
    
    locs = contains(vars,"NInterp");
    Ninterp_col = data_temp(:,locs);
    ...
    data.index = index;
    data.Ninterp = table2array(Ninterp_col);
end